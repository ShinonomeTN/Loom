...
public class HexTools {
    ...
    public static String toGB2312Str(byte[] data, int startPos, int length){
        try {
    ...
    /*
    * Merged CHexConvert into HexTools
    * */
     ...
     * @return String 每个Byte值之间空格分隔
     */
    public static String byte2HexStr(byte[] b, int iLen,char splitChar){
        StringBuilder sb = new StringBuilder();
        for (int n=0; n<iLen; n++){
            sb.append(mChars[(b[n] & 0xFF) >> 4]);
            sb.append(mChars[b[n] & 0x0F]);
